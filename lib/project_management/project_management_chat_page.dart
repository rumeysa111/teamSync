...
class ProjectManagementChatPage extends StatefulWidget {
  @override
  _ProjectManagementChatPageState createState() => _ProjectManagementChatPageState();
}

class _ProjectManagementChatPageState extends State<ProjectManagementChatPage> {
