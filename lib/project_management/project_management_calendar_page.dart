...
class ProjectManagementCalendarPage extends StatefulWidget {
  @override
  _ProjectManagementCalendarPageState createState() => _ProjectManagementCalendarPageState();
}

class _ProjectManagementCalendarPageState extends State<ProjectManagementCalendarPage> {
  ...
  void _fetchTeams() async {
    ...
    if(adminId !=null){
      final teamsSnapshot= await FirebaseFirestore.instance.collection('ekipler').where('adminId',isEqualTo: adminId).get();
      setState(() {
  ...
  void _showEditDialog(QueryDocumentSnapshot event) {
