...
class ManagementTeamChatPage extends StatefulWidget {
  @override
  _ManagementTeamChatPageState createState() => _ManagementTeamChatPageState();
}

class _ManagementTeamChatPageState extends State<ManagementTeamChatPage> {
...
*/
  ...
  Future<void> _sendToEveryone() async {
    ...
    Map<String, dynamic> messageData = {
      ...
      'createdAt': Timestamp.now(),
      'teamId':teamId,
      'adminId': adminId, // Burada adminId yerine teamId kullanılmış olabilir
    };
