...
class AssistantCalendarPage extends StatefulWidget {
  @override
  _AssistantCalendarPageState createState() => _AssistantCalendarPageState();
}

class _AssistantCalendarPageState extends State<AssistantCalendarPage> {
